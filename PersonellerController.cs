...
namespace KargoTakipSistemi1.Controllers
{
    public class MusterilerController : Controller
    {
        ...
        {
            return View(await _context.Musteriler
     ...
     .ToListAsync());
        ...
        public async Task<IActionResult> Create([Bind("Id,AdSoyad,Telefon,Email,Adres")] Musteri musteri)
        {
            if (ModelState.IsValid)
            {
                ...
                TempData["BasariMesaji"] = "Müþteri kaydý baþarýyla eklendi.";
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,AdSoyad,Telefon,Email,Adres")] Musteri musteri)
        {
            if (id != musteri.Id)
            {
                return NotFound();
            ...
            if (ModelState.IsValid)
            {
                try
                {
                    ...
                    TempData["BasariMesaji"] = "Müþteri kaydý baþarýyla güncellendi.";
                }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            TempData["BasariMesaji"] = "Müþteri kaydý baþarýyla silindi.";
